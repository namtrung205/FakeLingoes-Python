...
class OxFordDic():
	def __init__(self, app_id = "e28abe4e", app_key = "a49ac0dbc33be732616139ce323aba48" ,language ="en"):
		self.app_id = app_id
	...
	def JsonToDic(self, word_id):
		try:
			html = ""
			jsonDataUpdate = self.getJson(word_id)
			...
			for lexicalEntry in lexicalEntries:
				...
				for entry in entries:
					...
					for defAndExs in senses: 
						...
						html +=("<h4><font color='red'>%s: </font></h4>\n" % definitions[0])
