# -*- coding: utf-8 -*-
# UI Main
from PyQt5.QtCore import QFile, QIODevice, Qt, QTextStream, QEvent, QSize,QPoint,QStringListModel
...
class TranslateMainWindow(QWidget):
	...
	outputFont2 = QFont()
	outputFont2.setPointSize(10)
	

	outputFont3 = QFont()
	outputFont3.setPointSize(8)
